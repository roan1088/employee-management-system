...
async function main() {
    ...
    while (action !== "Exit") {
        ...
        const response = await inquirer.prompt({
            ...
            name: "action",
            choices: ["View All Employees", "View Employees by Manager", "View Employees by Role", "Add an Employee", "Update an Employee's Role", "Update an Employee's Manager", "Remove an Employee", "View All Roles", "Add a Role", "View All Departments", "Add a Department", "Exit"]
        });
        ...
        switch(action) {
            ...
            case "Update an Employee's Role":
                await orm.updateEmployeeRole();
                break;
            case "Update an Employee's Manager":
                await orm.updateEmployeeManager();
                break;
            case "Remove an Employee":
                await orm.removeEmployee();
                break;
            case "View All Roles":
